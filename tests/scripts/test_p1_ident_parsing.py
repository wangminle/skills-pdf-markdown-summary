...
from lib.idents import extract_figure_ident, extract_table_ident, parse_figure_ident
...
def test_parse_figure_ident_numeric_key():
    ...
    assert parse_figure_ident("SIV") == (True, 4)
    assert parse_figure_ident("IV") == (False, 4)
    assert parse_figure_ident("S1") == (True, 1)
    assert parse_figure_ident("1") == (False, 1)
